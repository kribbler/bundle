...
class PexetoOptions extends PexetoDataFields {
	 ...
	 * @return the poption value - if the option has a custom value saved, it returns the saved value. Otherwise it would return the default value set or if it is not set, it would return an empty string.
	 */
