		...
		$pexeto->meta = array(
			...
			'page'=> array(
				...
				array(
					...
					'type' => 'select',
					'data' => array( 'template' => 'default,template-contact.php,template-blog.php,template-portfolio-gallery.php' ),
				...
				array(
					...
					'std' => 'global',
					'desc' => 'You can set whether to display the page title or not - 
					if "Use Global Settings" selected, the global setting selected in 
				...
				array(
					...
					'std' => 'right',
					'desc' => 'Available for Default and Contact page templates',
					'data' => array( 'template' => 'template-blog.php' )
				),
			...
			'portfolio'=> array(
				...
				array(
					'name' => 'Crop thumbnail image from',
					'id' => PEXETO_META_PREFIX.'crop',
					'type' => 'imageradio',
					...
					'std' => 'c',
					'desc' => 'This option is available when the thumbnail will
					be automatically generated from the preview image (when the
						"Custom Thumbnail URL" field below is empty) - you can see 
					how the cropping settings will affect both portrait and
