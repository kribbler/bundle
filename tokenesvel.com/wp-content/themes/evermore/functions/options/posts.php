...
$pexeto_pages_options= array( array(
	...
	array(
		...
		'class'=>'exclude',
		'desc' => 'You can select which sections from the post info to be displayed.' )
	,
	...
	array(
		...
		'std' => 'readmore',
		'desc' => 'This is the way the summary is displayed. Using the "More" 
			...
			button that is located above the main content area.<br /><br />
	...
	array(
		...
		'class'=>'exclude',
		'desc' => 'You can select which sections from the item info to be displayed
		for the portfolio gallery pages and portfolio carousels.',
	),
