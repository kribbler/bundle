...
<form method="post" id="submit-form" class="pexeto-contact-form">
	...
	<div class="contact-form-input contact-input-wrapper">
		<label class="contact-label">
			<?php echo pexeto_text( 'name_text' );?>
	...
	<div class="contact-form-input contact-input-wrapper">
		<label class="contact-label">
			<?php echo pexeto_text( 'your_email_text' );?>
			<span class="mandatory">*</span>
		</label>
	...
	<div class="contact-form-textarea contact-input-wrapper">
		<label class="contact-label">
			<?php echo pexeto_text( 'question_text' );?>
			<span class="mandatory">*</span>
		</label>
	...
	<label class="contact-label"><?php echo pexeto_text( 'captcha_text' );?>
		<span class="mandatory">*</span>
	</label>
	<div class="contact-captcha-container">
		<div id="recaptcha_image"></div><div class="recaptcha-reload">
			<a title="<?php echo pexeto_text( 'refresh_btn_text' ); ?>" href="javascript:Recaptcha.reload()"></a>
		</div>
	...
	<a class="button send-button">
		<span><?php echo pexeto_text( 'send_text' );?></span>
	</a>
