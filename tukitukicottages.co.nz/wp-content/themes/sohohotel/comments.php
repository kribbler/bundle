...
<?php if ( have_comments() ) : ?>
	...
	<h4 class="title-style3"><?php comments_number(__('No comments', 'qns'), __('1 Comment', 'qns'), __('% Comments', 'qns')); ?><span class="title-block"></span></h4>
...
if ( comments_open() ) : 
	...
	comment_form( array(
		...
		'title_reply'				=>	__( 'Leave a Comment<span class="title-block"></span>', 'qns' ),
