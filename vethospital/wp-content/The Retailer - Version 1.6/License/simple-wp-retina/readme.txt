...
*   Detects a high DPI screen such as a Retina display
*   Detects all theme added image sizes and adds @2x versions.
*   Replaces featured thumbnails and content images with the @2x versions.
...
Are you using any form of caching? Unfortunately the plugin currently is not friendly with caching.
