		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'text':
					...
					(isset($data[$value['id']]))? $t_value = stripslashes($data[$value['id']]) : $t_value="";
				...
				case 'textarea':	
					...
					if(isset($value['options'])){
						...
						(isset($data[$value['id']]))? $ta_value = stripslashes($data[$value['id']]) : $ta_value="";			
				...
				case 'color':		
					...
					$output .= '<div id="' . $value['id'] . '_picker" class="colorSelector"><div style="background-color: '.(isset($data[$value['id']]) ? $data[$value['id']] : "").'"></div></div>';
					$output .= '<input class="of-color" name="'.$value['id'].'" id="'. $value['id'] .'" type="text" value="'.(isset($data[$value['id']]) ? $data[$value['id']] : "").'" />';
				...
				case 'border':
					...
					$border_stored = isset($data[$value['id']]) ? $data[$value['id']] : $value['std'];
