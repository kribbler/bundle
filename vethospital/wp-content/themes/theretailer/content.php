...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it. ?>
        <div class="entry-thumbnail gbtr_blog_listing">
    ...
    <div class="entry-content gbtr_blog_listing">
		<?php //the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'theretailer' ) ); ?>
		<?php global $more; $more = 0; the_excerpt(); //the_content( __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'theretailer' ) ); ?>
