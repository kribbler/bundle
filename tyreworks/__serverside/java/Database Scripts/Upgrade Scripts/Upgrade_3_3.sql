...
ALTER TABLE Tyres ADD COLUMN IsSummerTyre       bit  DEFAULT NULL;
ALTER TABLE Tyres ADD COLUMN IsWinterTyre       bit  DEFAULT NULL;
ALTER TABLE Tyres ADD COLUMN TyreCatalogueRef   int  DEFAULT NULL;