...
<div class="gbtr_main_wrapper">
    ...
    <form action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
        ...
        <div class="shop_table_wrapper">
            ...
            <style type="text/css">.variation{display: none;}</style>
                    <?php
                                ...
                                <tr class = "<?php echo esc_attr( apply_filters('woocommerce_cart_table_item_class', 'cart_table_item', $values, $cart_item_key ) ); ?>">
                                    ...
                                    <td class="product-thumbnail">
                                        <?php
                                            ...
                                            $thumbnail = apply_filters( 'woocommerce_in_cart_product_thumbnail', '<img src="'.get_stylesheet_directory_uri().'/images/default_tyre.png'.'" />', $values, $cart_item_key );
