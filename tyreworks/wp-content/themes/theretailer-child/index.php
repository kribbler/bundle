	...
	?>
    	...
    	<div class="grid_12">
            <div class="gbtr_home_no_widgets">
                ...
                <h3>This is the default Welcome page. <strong>Get started</strong> with setting up your <a href="<?php echo site_url(); ?>/wp-admin/options-reading.php"><strong>Front Page</strong></a>.<h3>
