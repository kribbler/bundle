...
<body <?php body_class(); ?>>
    ...
    <?php if (is_front_page()) {
    	$home_class = " class='home_class'"; 
	} else $home_class = "";?>
    <div id="global_wrapper" <?php echo $home_class?>>
        ...
        <div class="container_12">
            ...
            <div class="grid_9">
                <div class="menus_wrapper" <?php if ( ($theretailer_theme_options['catalog_mode']) && ($theretailer_theme_options['catalog_mode'] == 1) ) { ?>style="margin:0"<?php } ?>>
                    ...
                    <div class="gbtr_second_menu" style="display: none">
                        <ul>
                                    ...
                                    if (sizeof($woocommerce->cart->cart_contents)>0) : foreach ($woocommerce->cart->cart_contents as $cart_item_key => $cart_item) :
                                        ...
                                        if ($_product->exists() && $cart_item['quantity']>0) :                                            
                                            echo '<li class="cart_list_product">';                                                
                                                ...
                                                echo '<a class="cart_list_product_img" href="'.get_permalink($cart_item['product_id']).'"><img src="'.get_stylesheet_directory_uri().'/images/default_tyre.png" /></a>';                                                    
    ...
    <?php if (is_front_page()) { ?>
    	<div class="container_12">
    		<div id="home_sheader">
    			<div id="home_search_box" class="home_top">
    				<?php dynamic_sidebar('header_left');?>    				
    			</div>
    			<div id="home_indep" class="home_top">
    				<?php dynamic_sidebar('header_right');?>
    			</div>
    			<div class="clear"></div>

    			<?php dynamic_sidebar('header_slogan');?>
    		</div>
    	</div>
    <?php }?>
