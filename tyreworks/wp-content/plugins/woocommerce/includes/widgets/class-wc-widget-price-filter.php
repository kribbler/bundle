...
class WC_Widget_Price_Filter extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$extra_filters = "";
		if (isset($_GET['enter_your_reg'])){
			$extra_filters .= '<input type="hidden" name="enter_your_reg" value="'.$_GET['enter_your_reg'].'" />';
		}
		if (isset($_GET['pa_width'])){
			$extra_filters .= '<input type="hidden" name="pa_width" value="'.$_GET['pa_width'].'" />';
		}
		if (isset($_GET['pa_rim-size'])){
			$extra_filters .= '<input type="hidden" name="pa_rim-size" value="'.$_GET['pa_rim-size'].'" />';
		}
		if (isset($_GET['pa_brand'])){
			$extra_filters .= '<input type="hidden" name="pa_brand" value="'.$_GET['pa_brand'].'" />';
		}
		if (isset($_GET['pa_profile'])){
			$extra_filters .= '<input type="hidden" name="pa_profile" value="'.$_GET['pa_profile'].'" />';
		}
		if (isset($_GET['pa_speed'])){
			$extra_filters .= '<input type="hidden" name="pa_speed" value="'.$_GET['pa_speed'].'" />';
		}
		if (isset($_GET['post_type'])){
			$extra_filters .= '<input type="hidden" name="post_type" value="'.$_GET['post_type'].'" />';
		}
		if (isset($_GET['tyres_for'])){
			$extra_filters .= '<input type="hidden" name="tyres_for" value="'.$_GET['tyres_for'].'" />';
		}
