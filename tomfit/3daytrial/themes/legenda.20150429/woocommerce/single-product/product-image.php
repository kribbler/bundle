				...
				<div class="main-image-slider <?php if ($zoom != 'disable') {echo 'zoom-enabled';} ?>">
					...
					<ul class="slides">
						...
						<li>
							...
							<?php endif ?>
							<a href="<?php echo $image_link; ?>" class="main-image zoom" <?php if($zoom == 'disable'): ?>rel="<?php echo $lightbox_rel; ?>"<?php endif; ?> id="main-zoom-image"><img src="<?php echo $image; ?>" title="<?php echo $image_title ?>"></a></li>
