...
<head>
   <!-- Facebook Conversion Code for TOMFIT signups -->
<script>(function() {
...
window._fbq.push(['track', '6015464387233', {'value':'0.00','currency':'NZD'}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6015464387233&amp;cd[value]=0.00&amp;cd[currency]=NZD&amp;noscript=1" /></noscript>   
<script>(function() {
  var _fbq = window._fbq || (window._fbq = []);
  if (!_fbq.loaded) {
    var fbds = document.createElement('script');
...
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?id=1467292390178359&amp;ev=PixelInitialized" /></noscript> 
...
.landing-header-3 input, [type="text"], .landing-header-4 input, [type="text"] { background-color: #fff !important; width: 100%; }
...
.landing-header-1 input[type="submit"] { padding: 10px 50px !important; }
...
<div class="landing-header-1">
	<div class="container">
		<?php echo do_shortcode("[block id='218']"); //Dont wait another Monday?>
	</div>
</div>
